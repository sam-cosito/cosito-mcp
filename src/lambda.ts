...
export const handler = async (event: FnUrlEvent): Promise<LambdaResult> => {
  ...
  if (path === "/token" && method === "POST") {
    ...
    try {
      ...
      if (tokenJson.access_token) console.log("access_token:", tokenJson.access_token);
      if (tokenJson.id_token) console.log("id_token:", tokenJson.id_token);
      if (tokenJson.refresh_token) console.log("refresh_token:", tokenJson.refresh_token);
